...
class CourseDetailsJobAssistanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
            'title' => is_array($request->input('title')) ? $request->input('title') : ['text' => $request->input('title')],
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->title = is_array($request->input('title')) ? $request->input('title') : ['text' => $request->input('title')];
